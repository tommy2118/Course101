...
def display_dealers_initial_hand(card_one, card_two)
  puts ""
  puts "+" + "-" * 11 + "+" + "  " + "+" + "-" * 11 + "+"
  puts "|" + card_one[0].to_s + " " * 10 + "|" + "  " + "|" + " " * 11 + "|"
  puts "|" + " " * 11 + "|" + "  " + "|" + " " * 11 + "|"
  puts "|" + " " * 11 + "|" + "  " + "|" + " " * 11 + "|"
  puts "|" + " " * 5 + card_one[1] + " " * 5 + "|" + "  " + "|" + " " * 11 + "|"
  puts "|" + " " * 11 + "|" + "  " + "|" + " " * 11 + "|"
  puts "|" + " " * 11 + "|" + "  " + "|" + " " * 11 + "|"
  puts "|" + " " * 10 + card_one[0].to_s +  "|" + "  " + "|" + " " * 11 + "|"
  puts "+" + "-" * 11 + "+" + "  " + "+" + "-" * 11 + "+"
end
...
def display_two_card_hand(card_one, card_two)
  puts ""
  puts "+" + "-" * 11 + "+" + "  " + "+" + "-" * 11 + "+"
  puts "|" + card_one[0].to_s + " " * 10 + "|" + "  " + "|" + card_two[0].to_s + " " * 10 + "|"
  puts "|" + " " * 11 + "|" + "  " + "|" + " " * 11 + "|"
  puts "|" + " " * 11 + "|" + "  " + "|" + " " * 11 + "|"
  puts "|" + " " * 5 + card_one[1] + " " * 5 + "|" + "  " + "|" + " " * 5 + card_one[1] + " " * 5 + "|"
  puts "|" + " " * 11 + "|" + "  " + "|" + " " * 11 + "|"
  puts "|" + " " * 11 + "|" + "  " + "|" + " " * 11 + "|"
  puts "|" + " " * 10 + card_one[0].to_s +  "|" + "  " + "|" + " " * 10 + card_two[0].to_s +  "|"
  puts "+" + "-" * 11 + "+" + "  " + "+" + "-" * 11 + "+"
end
...
def render_cards(*hand)
  ...
  hand.each do |card|
    part_one << "+" + "-" * 11 + "+" + "  "
    part_two << "|" + card[0].to_s + " " * 10 + "|" + "  "
    part_three << "|" + " " * 11 + "|" + "  "
    part_four << "|" + " " * 11 + "|" + "  "
    part_five << "|" + " " * 5 + card[1] + " " * 5 + "|" + "  "
    part_six << "|" + " " * 11 + "|" + "  "
    part_seven << "|" + " " * 11 + "|" + "  "
    part_eight << "|" + " " * 10 + card[0].to_s +  "|" + "  "
    part_nine << "+" + "-" * 11 + "+" + "  "
  end
  puts part_one.join
  puts part_two.join
...
display_two_card_hand(*players_hand)
deal_card(deck, players_hand)
deal_card(deck, players_hand)
deal_card(deck, players_hand)
deal_card(deck, players_hand)
